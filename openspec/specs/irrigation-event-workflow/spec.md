# Irrigation Event Workflow Specification

## Purpose

Defines the irrigation event workflow including interactive plant selection map, per-row coverage levels, impact recording, and transactional bulk save.
